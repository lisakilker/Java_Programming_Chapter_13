...
class Event {
    ...
    public final static double PRICE_PER_GUEST_LOW = 32.00;
    public final static double PRICE_PER_GUEST_HIGH = 35.00;
    public final static int CUT_OFF_AMOUNT = 50;
    ...
    public final static String EVENT_TYPE_NAMES[] = {"Wedding", "Baptism", "Birthday", "Corporate", "Other"};
    ...
    public void setGuests(int guestAmount) {
        ...
        if (isLargeEvent()) {
            ...
            price = guests * PRICE_PER_GUEST_LOW;
        } else {
            pricePerGuest = PRICE_PER_GUEST_HIGH;
            price = guests * PRICE_PER_GUEST_HIGH;
        }
    }
